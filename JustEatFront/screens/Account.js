...
import { Text, View, StyleSheet, Dimensions, TouchableOpacity, ImageBackground, Image, LayoutAnimation, UIManager, Platform, Animated, ScrollView, Linking } from 'react-native';
...
const AccountScreen = () => {
    ...
    return (
        state?.user === null ?
            ...
            <ScrollView style={styles.account_container} showsVerticalScrollIndicator={false}>
                ...
                <Divider style={{ margin: 15, height: 2, backgroundColor: '#ecfaff' }} />
                <TouchableOpacity onPress={() => {
                    ...
                    <View style={styles.expandable_tile}>
                        ...
                        <AnimatedView name='keyboard-arrow-right' size={25} style={{
                ...
                <TouchableOpacity onPress={() => Linking.openURL('mailto:JustEatsupport@gmail.com?subject=Get Support')}>
                    <Managecompo iconname='envelope' title='Send Feedback' />
                </TouchableOpacity>
                <View style={styles.order_cont}>
                    <Text style={styles.Past_order_text}>Past Orders</Text>
                    <Image source={require('../assets/Tummy.png')} style={{ height: 200, width: 200, alignSelf: 'center' }} />
                </View>
                <Ordercompo />
                <Border height={20} />
                ...
                >
                    <View style={styles.bottomsheet}>
                        <EditInfoCompo phone={state.user.user.Phone} email={state.user.user.email}
