    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.background}>
        ...
        <TextInput
          ...
          autoCapitalize="none"
          autoCorrect={false}
          onEndEditing={() => Filtersearch(term)}
          onKeyPress={() => fun()}
          selectTextOnFocus
          selectionColor="#ecfaff"
        />
        <TouchableOpacity
          onPress={() => {
            setTerm("");
        ...
        <View>
          ...
          <View style={styles.imgcont}>
            <TouchableOpacity onPress={() => Filtersearch("burger")}>
              <Image
                source={{ uri: `${Server}/images/${burger_img}` }}
                style={styles.img}
              />
            ...
            <TouchableOpacity onPress={() => Filtersearch("maggi")}>
              <Image
                source={{ uri: `${Server}/images/${noodle_img}` }}
                style={styles.img}
              />
            ...
            <TouchableOpacity onPress={() => Filtersearch("veg")}>
              <Image
                source={{ uri: `${Server}/images/${veg_img}` }}
                style={styles.img}
              />
